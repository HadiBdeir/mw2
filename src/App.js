    ...
    <BrowserRouter basename="/mw2">
      ...
      <Routes>
        ...
        <Route
          ...
          element={<CyberSecurityAndPrivacy />}
        />
        <Route
          path="/account-protection-screen"
          element={<AccountProtectionScreen />}
        />
        <Route
          path="/device-protection-screen"
          element={<DeviceProtectionScreen />}
        />
        ...
        <Route
          path="/digital_privacy_screen"
          element={<DigitalPrivacyScreen />}
        />
        <Route
          path="/creating_strong_password_screen"
          element={<CreatingStrongPasswordScreen />}
        />
        ...
        <Route
          path="/digital-journeys-homepage-screen"
          element={<DigitalJourneysHomepage />}
        />
        <Route
          path="/digital-journeys-sample-screen"
          element={<DigitalJourneysSample />}
        />
      </Routes>
    </BrowserRouter>
  );
